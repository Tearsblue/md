...
int InitSerial(void)
{
    try
    {
        ser.setPort("/dev/ttyMDUI"); // edited 22.12.14 // this is symbolicLink; ttyMDUI is unique name of the USB hardware
    ...
    switch(byPID)
    {
        ...
        case PID_PNT_VEL_CMD:
            ...
            */
            ...
            Com.bySndBuf[4]  = byDataSize;
            Com.bySndBuf[5]  = ENABLE;      // D1
            Com.bySndBuf[6]  = nArray[0];   // D2
            Com.bySndBuf[7]  = nArray[1];   // D3
            Com.bySndBuf[8]  = ENABLE;      // D4
            Com.bySndBuf[9]  = nArray[2];   // D5
            Com.bySndBuf[10] = nArray[3];   // D6
            Com.bySndBuf[11] = nArray[4];   // D7
