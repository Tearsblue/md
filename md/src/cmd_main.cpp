...
#include "md/vel_msg.h" // added 22.12.14
#include "md/monitor_msg.h" // added 22.12.14
...
//    Md.sTheta             = monitor->sTheta;
    ...
    printf("sub-> x: %ld  y: %ld  theta: %3.1f  linearVel: %d  angularVel: %4.1f  L_Cur: %d  R_Cur: %d  US1:%d  US2:%d  US3:%d  US4:%d "
           "volt:%d  Emergecy:%d  Charge:%d  DocState:%d  LMotStatu:%d  RMotStatu:%d  LDirPin:%d  LSSPin:%d  "
           "RDirPin:%d  RSSPin:%d \n",
           Md.lPosiX, Md.lPosiY, Md.fTheta, Md.sRealLinearVel, Md.fRealAngularVel, Md.sCurrent[LEFT], Md.sCurrent[RIGHT], Md.byUS1, Md.byUS2, Md.byUS3, Md.byUS4, Md.sVoltIn,
    ...
    // printf("sub-> x: %ld  y: %ld  theta: %3.1f  linearVel: %d  angularVel: %4.1f  L_Cur: %d  R_Cur: %d  US1:%d  US2:%d  US3:%d  US4:%d "
    //        "volt:%d  Emergecy:%d  Charge:%d  DocState:%d  LMotStatu:%d  RMotStatu:%d  LDirPin:%d  LSSPin:%d  "
    //        "RDirPin:%d  RSSPin:%d  invVelLeft:%d  invVelRight:%d \n",
    //        Md.lPosiX, Md.lPosiY, Md.fTheta, Md.sRealLinearVel, Md.fRealAngularVel, Md.sCurrent[LEFT], Md.sCurrent[RIGHT], Md.byUS1, Md.byUS2, Md.byUS3, Md.byUS4, Md.sVoltIn,
    //        Md.fgEmerON, Md.fgBatChargeON, Md.fgRccState, Md.byMotStatus[LEFT], Md.byMotStatus[RIGHT], Md.fgDirection[LEFT], Md.fgStartStop[LEFT]
    //        , Md.fgDirection[RIGHT], Md.fgStartStop[RIGHT], Md.fgInvVel[LEFT], Md.fgInvVel[RIGHT]);
}
...
int main(int argc, char** argv)
{
    ...
    ros::Rate r(20); // hz                                                                      //Set the loop period -> 50ms.
